...
class InMemoryRailRepository(RailRepository):
    def __init__(self) -> None:
        self._stations = [
            ...
            Station("HW", "Haridwar Junction", "Haridwar", "Uttarakhand", 80, True),
            Station("MBNL", "Marwar Bhinmal", "Bhinmal", "Rajasthan", 70, False),
        ]
        ...
        self._segments = [
            ...
            # ── Bridge segments: West ↔ East corridors ──────────
            TrainSegment(
                "12310",
                "Rajdhani Express",
                "NDLS",
