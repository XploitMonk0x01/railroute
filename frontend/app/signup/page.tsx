  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -left-40 size-[500px] rounded-full bg-indigo-500/8 blur-3xl" />
        <div className="absolute -bottom-40 -right-40 size-[500px] rounded-full bg-cyan-500/8 blur-3xl" />
      </div>
        ...
        <CardContent className="p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Join RailRoute AI for watchlist alerts and saved searches
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full gap-2 bg-gradient-to-r from-indigo-500 to-cyan-500 text-white shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 mt-2"
            >
